...
import OffersListTaken from "../OffersListTaken";
...
describe('OffersListTaken component', () => {
    ...
    it('renders properly with fake props and mocked redux state.', () => {
        const wrapper = mount(
            <Provider store={store}>
                <OffersListTaken {...props}/>
            </Provider>
        );
        expect(wrapper.find(OffersListTaken).length).to.equal(1);
