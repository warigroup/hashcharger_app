...
class EditStratumSetting extends React.Component {
  constructor() {
    super();
    this.state = {
      isLoading: true,
    ...
    const successAlert = (
      ...
      >
        <p style={{ fontSize: "0.7em" }}>
          <br />
          You have successfully updated stratum setting in your order!
          <br />
  ...
  render() {
    ...
    const stratumList = this.props.stratum.stratum_list.map(stratum_list => {
      if (stratum_list.mining_algo == this.props.bids.bid_info.result[0].mining_algo) {
        return (
        <option
      ...
      return (
          <PublicRoute>
            <Head>
            <title>WariHash | Edit Stratum Setting</title>
          ...
          {this.props.bids.bid_info.result.map(bid => {  
               ...
               <div className="container">
                 <div className="row">
                   <div className="col-xl-12 col-lg-12 col-md-12 col-lg-12">
                    <h4 className="page-title">Edit Stratum Setting for Order #{bid.bid_id}</h4>
                    <br />
                    <h5 className="editpagetitle">
                            Current stratum setting:
                          </h5>
                          <p className="currentsetting">Host: {bid.stratum_host}</p>
                          <p className="currentsetting">Port: {bid.stratum_port}</p>
                          <p className="currentsetting">Username: {bid.stratum_username}</p>
                          <br/>
                    </div>
               
                   {this.props.stratum.stratum_list.length > 0 &&
                     this.props.stratum.stratum_list.findIndex(stratum => stratum.mining_algo == this.props.bids.bid_info.result[0].mining_algo) !== -1 ?
           ...
           {this.state.networkerror !== "" ? 
            ...
            onClick={() => this.editMyBid(bid.bid_id)}>{this.state.editformloading === true ? 
              <ThreeDotsLoading /> : <p style={{paddingTop: "0px", paddingBottom: "0px", marginBottom: "0px",
  ...
  EditStratumSetting.defaultProps = {
    auth: [],
    errors: [],
    profile: [],
    payment: [],
  ...
  export default connect(mapStateToProps, 
    {resetErrors, 
      ...
      clearAlert,
      clearPaymentInfo,
      timeoutError})(EditStratumSetting);